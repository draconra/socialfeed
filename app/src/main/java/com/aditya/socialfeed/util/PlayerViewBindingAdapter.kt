...
class PlayerViewAdapter {
    ...
    companion object{
        ...
        * */
        ...
        fun PlayerView.loadVideo(url: String?, callback: PlayerStateCallback?, progressbar: LinearLayout, thumbnail: ImageView, item_index: Int? = null, autoPlay: Boolean = false) {
            if (url == null) return
